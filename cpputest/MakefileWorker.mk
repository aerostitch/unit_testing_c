...
#   CPPUTEST_SCRIPTS_HOME - where CppUTest scripts dir found
...
ifeq ($(CPPUTEST_USE_VPATH), Y)
	...
	$(CPPUTEST_SCRIPTS_HOME)/scripts/filterGcov.sh $(GCOV_OUTPUT) $(GCOV_ERROR) $(GCOV_REPORT) $(TEST_OUTPUT)
...
.PHONY: format
format:
	$(CPPUTEST_SCRIPTS_HOME)/scripts/reformat.sh $(PROJECT_HOME_DIR)
